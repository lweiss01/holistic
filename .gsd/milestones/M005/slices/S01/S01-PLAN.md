...
## Tasks
- [x] **T01: Start the live stack** - Run the SQLite migrate/seed flow, boot the Andon API, and launch the React dashboard together with clear local commands.
  - Estimate: 20m
...
- [x] **T02: Walk the three dashboard views live** - Exercise active session, timeline, and session detail in the browser and note any rendering, routing, or data-shape issues.
  - Estimate: 25m
...
- [x] **T03: Trigger live status movement** - Post one or more live collector events while the UI is open and confirm status and recommendation updates match expectations.
  - Estimate: 20m
...
- [x] **T04: Capture findings and convert them into follow-up work** - Write a short summary of defects, UX gaps, and reliability concerns uncovered during the live run, then feed the meaningful ones into S02-S04 or new tasks.
  - Estimate: 15m

...
- [ ] **T01: Research MCP notification delivery mechanisms** `est:1h`
...
- [ ] **T02: Build shared startup greeting formatter** `est:30m`
...
- [ ] **T03: Enhance MCP notification delivery** `est:1h`
...
- [ ] **T04: Add `/holistic` slash command handler** `est:45m`
...
- [ ] **T05: Add unit test for startup greeting format** `est:30m`
...
- [ ] **T06: Update AGENTS.md with /holistic pattern** `est:30m`
...
- [ ] **T08: Manual UAT - /holistic command** `est:15m`

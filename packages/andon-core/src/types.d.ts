...
export declare const EVENT_TYPES: readonly ["session.started", "session.ended", "session.idle_detected", "session.checkpoint_created", "session.heartbeat", "session.paused", "session.resumed", "session.completed", "session.failed", "session.cancelled", "session.terminated", "task.started", "task.updated", "task.completed", "phase.changed", "tool.started", "tool.completed", "tool.failed", "command.started", "command.finished", "command.completed", "command.failed", "file.changed", "test.started", "test.finished", "test.completed", "test.failed", "input.requested", "input.resolved", "git.branch_created", "context.branch_changed", "context.environment_changed", "git.commit_created", "git.conflict_detected", "agent.question", "agent.question_asked", "agent.summary", "agent.summary_emitted", "agent.warning", "agent.blocked", "agent.retry_pattern_detected", "agent.scope_expansion_detected", "holistic.checkpoint", "telemetry.noop", "user.action", "user.resumed"];
